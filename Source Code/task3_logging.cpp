...
bool CircularActivityLog::isEmpty() const { return count == 0; }
bool CircularActivityLog::isFull() const { return count == capacity; }
int CircularActivityLog::size() const { return count; }
int CircularActivityLog::getCapacity() const { return capacity; }
...
void CircularActivityLog::exportCSV(const string& filename) const {
    ...
    if (!file.is_open()) {
        cout << "  [ERROR] Could not open file for export.\n";
        return;
    }
    ...
    do {
        ...
        switch (choice) {
            case 1: {
                ...
                // Single while loop for ID input
                while (true) {
                    ...
                    if (!learner) {
                        ...
                        if (tolower(choice) != 'y') {
                            ...
                            break;  // User wants to continue with unknown
                        }
                    } else {
                        break;  // Learner found
                    }
